...
# xaxis3 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis3 = dict(title=r"$p$", title_standoff=standoff_y),
# xaxis4 = dict(title=r"$p$", title_standoff=standoff_x), yaxis4 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
#
# xaxis5 = dict(title=r"$H_e$", title_standoff=standoff_x), yaxis5 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
# xaxis6 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis6 = dict(title=r"$C_{ie}$",
#                                                                            title_standoff=standoff_y),
# xaxis7 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis7 = dict(title=r"$p$", title_standoff=standoff_y),
# xaxis8 = dict(title=r"$p$", title_standoff=standoff_x), yaxis8 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
#
# xaxis9 = dict(title=r"$H_e$", title_standoff=standoff_x), yaxis9 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
# xaxis10 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis10 = dict(title=r"$C_{ie}$",
#                                                                              title_standoff=standoff_y),
# xaxis11 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis11 = dict(title=r"$p$", title_standoff=standoff_y),
# xaxis12 = dict(title=r"$p$", title_standoff=standoff_x), yaxis12 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
#
# xaxis13 = dict(title=r"$H_e$", title_standoff=standoff_x), yaxis13 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
# xaxis14 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis14 = dict(title=r"$C_{ie}$",
#                                                                              title_standoff=standoff_y),
# xaxis15 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis15 = dict(title=r"$p$", title_standoff=standoff_y),
# xaxis16 = dict(title=r"$p$", title_standoff=standoff_x), yaxis16 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
#
# xaxis17 = dict(title=r"$H_e$", title_standoff=standoff_x), yaxis17 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
# xaxis18 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis18 = dict(title=r"$C_{ie}$",
#                                                                              title_standoff=standoff_y),
# xaxis19 = dict(title=r"$C_{ee}$", title_standoff=standoff_x), yaxis19 = dict(title=r"$p$", title_standoff=standoff_y),
# xaxis20 = dict(title=r"$p$", title_standoff=standoff_x), yaxis20 = dict(title=r"$C_{ie}$", title_standoff=standoff_y),
